...
- `_001_parser.py`: parse SAD file content into structured sections. Parse errors cite the source line number; SAD function definitions (`:=`) are rejected explicitly rather than silently misparsed — see `docs/development/design-decisions.md`.
