...
- `test_refshift_writer.py` — `xt.XYShift` (dx/dy), `xt.TimeDelay` (shift_zeta), `xt.YRotation` (chi1), `xt.XRotation` (chi2), `xt.SRotation` (chi3); all as optics expressions; zero default_to_zero behaviour; all five types in one line
