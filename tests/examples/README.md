...
Requires the SAD binary.

| File | Tests | Fail | Failure root cause |
|------|-------|------|--------------------|
| `test_example_lattices.py` | 3 | 0 | — |
| `test_public_examples.py` | 14 | 0 | — |

- `test_example_lattices.py` — conversion
...
- `test_public_examples.py` — covers the full public example
