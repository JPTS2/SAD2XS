...
def test_pipeline_reference_particle_explicit_charge_is_preserved(write_lattice):
    """
    An explicit SAD CHARGE global should be reflected in the reference particle q0.
    """
    lattice_path = write_lattice(
        """\
        MOMENTUM    = 1.0 GEV;
