...
def test_sol_off_in_dxdy():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdy",
...
def test_sol_off_in_dxdy_rev_in():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdy_rev_in",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdy_rev_out():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdy_rev_out",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdy_rev_both():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdy_rev_both",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dz():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dz",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dz_rev_in():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dz_rev_in",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dz_rev_out():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dz_rev_out",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dz_rev_both():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dz_rev_both",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dpx():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dpx",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dpx_rev_in():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dpx_rev_in",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dpx_rev_out():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dpx_rev_out",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dpx_rev_both():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dpx_rev_both",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dpy():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dpy",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dpy_rev_in():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dpy_rev_in",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dpy_rev_out():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dpy_rev_out",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dpy_rev_both():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dpy_rev_both",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_chi1():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_chi1",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_chi1_rev_in():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_chi1_rev_in",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_chi1_rev_out():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_chi1_rev_out",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_chi1_rev_both():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_chi1_rev_both",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_chi2():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_chi2",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_chi2_rev_in():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_chi2_rev_in",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_chi2_rev_out():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_chi2_rev_out",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_chi2_rev_both():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_chi2_rev_both",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdydpx():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdydpx",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdydpx_rev_in():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdydpx_rev_in",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdydpx_rev_out():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdydpx_rev_out",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdydpx_rev_both():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdydpx_rev_both",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdydpy():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdydpy",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdydpy_rev_in():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdydpy_rev_in",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdydpy_rev_out():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdydpy_rev_out",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdydpy_rev_both():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdydpy_rev_both",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdychi1():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdychi1",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdychi1_rev_in():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdychi1_rev_in",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdychi1_rev_out():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdychi1_rev_out",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdychi1_rev_both():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdychi1_rev_both",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdychi2():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdychi2",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdychi2_rev_in():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdychi2_rev_in",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdychi2_rev_out():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdychi2_rev_out",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdychi2_rev_both():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdychi2_rev_both",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdydpxdpy():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdydpxdpy",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdydpxdpy_rev_in():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdydpxdpy_rev_in",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdydpxdpy_rev_out():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdydpxdpy_rev_out",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdydpxdpy_rev_both():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdydpxdpy_rev_both",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdychi1chi2():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdychi1chi2",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdychi1chi2_rev_in():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdychi1chi2_rev_in",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdychi1chi2_rev_out():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdychi1chi2_rev_out",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
...
def test_sol_off_in_dxdychi1chi2_rev_both():
    ...
    """
    reference_sol_test(
        test_name                  = "test_007a_sol_off_in_dxdychi1chi2_rev_both",
        sad_elements_line_string   = textwrap.dedent(f"""\
            DRIFT       SOL_DRIFT   = (L = 1.00);
